...
import (
	...
	"github.com/Thurston00/go-rethereum/crypto/signify"
	"github.com/Thurston00/go-rethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/Thurston00/go-rethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/Thurston00/go-rethereum/internal/version.gitDate="+env.Date)
	}
